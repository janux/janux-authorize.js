...
var AuthorizationContext_1 = require('../src/impl/AuthorizationContext');
var PermissionBit_1 = require('../src/impl/PermissionBit');
...
describe('PermissionContext', function () {
    ...
    beforeEach(function () {
        authContext = new AuthorizationContext_1["default"]('PERSON', 'Defines permissions available on a Person entity');
    });
    it('should be able to add/retrieve PermissionBits', function () {
        authContext.addPermissionBit(new PermissionBit_1["default"]('READ', 'Grants permission to READ a PERSON'));
        authContext.addPermissionBit(new PermissionBit_1["default"]('UPDATE', 'Grants permission to UPDATE a PERSON', 99));
