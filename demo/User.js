...
var
    ...
    util   = require('util'),
    Account = require('../../index')['Account'], // require('../Account')['Account']
    AuthorizationHolder = rfr('index').AuthorizationHolder,
    AuthService = require('../src/impl/AuthorizationService')
    ;
